...
class DeSmuME_SDL_Window:
    ...
    def __init__(self, emu: "DeSmuME", auto_pause=True, use_opengl_if_possible=True):
        self.lib = emu.lib
        self.lib.desmume_draw_window_init(
            bool(auto_pause), bool(use_opengl_if_possible)
        )
...
class DeSmuME_Movie:
    ...
    def record(
        ...
        file_name: str,
        author_name: str,
        start_from: StartFrom = StartFrom.START_BLANK,
        sram_save: str = "",
        rtc_date: DeSmuME_Date = None,
    ):
        """
        Record a movie.
        ...
        if not rtc_date:
            self.emu.lib.desmume_movie_record(
                c_char_p(strbytes(file_name)),
                c_char_p(strbytes(author_name)),
                start_from.value,
                c_char_p(strbytes(sram_save)),
            )
        else:
...
class RegisterAccessor:
    ...
    @property
    def r0(self):
        return self.lib.desmume_memory_read_register(
            c_char_p(strbytes(self.prefix + "r0"))
        )

    @r0.setter
    def r0(self, value):
        self.lib.desmume_memory_write_register(
            c_char_p(strbytes(self.prefix + "r0")), value
        )

    @property
    def r1(self):
        return self.lib.desmume_memory_read_register(
            c_char_p(strbytes(self.prefix + "r1"))
        )

    @r1.setter
    def r1(self, value):
        self.lib.desmume_memory_write_register(
            c_char_p(strbytes(self.prefix + "r1")), value
        )

    @property
    def r2(self):
        return self.lib.desmume_memory_read_register(
            c_char_p(strbytes(self.prefix + "r2"))
        )

    @r2.setter
    def r2(self, value):
        self.lib.desmume_memory_write_register(
            c_char_p(strbytes(self.prefix + "r2")), value
        )

    @property
    def r3(self):
        return self.lib.desmume_memory_read_register(
            c_char_p(strbytes(self.prefix + "r3"))
        )

    @r3.setter
    def r3(self, value):
        self.lib.desmume_memory_write_register(
            c_char_p(strbytes(self.prefix + "r3")), value
        )

    @property
    def r4(self):
        return self.lib.desmume_memory_read_register(
            c_char_p(strbytes(self.prefix + "r4"))
        )

    @r4.setter
    def r4(self, value):
        self.lib.desmume_memory_write_register(
            c_char_p(strbytes(self.prefix + "r4")), value
        )

    @property
    def r5(self):
        return self.lib.desmume_memory_read_register(
            c_char_p(strbytes(self.prefix + "r5"))
        )

    @r5.setter
    def r5(self, value):
        self.lib.desmume_memory_write_register(
            c_char_p(strbytes(self.prefix + "r5")), value
        )

    @property
    def r6(self):
        return self.lib.desmume_memory_read_register(
            c_char_p(strbytes(self.prefix + "r6"))
        )

    @r6.setter
    def r6(self, value):
        self.lib.desmume_memory_write_register(
            c_char_p(strbytes(self.prefix + "r6")), value
        )

    @property
    def r7(self):
        return self.lib.desmume_memory_read_register(
            c_char_p(strbytes(self.prefix + "r7"))
        )

    @r7.setter
    def r7(self, value):
        self.lib.desmume_memory_write_register(
            c_char_p(strbytes(self.prefix + "r7")), value
        )

    @property
    def r8(self):
        return self.lib.desmume_memory_read_register(
            c_char_p(strbytes(self.prefix + "r8"))
        )

    @r8.setter
    def r8(self, value):
        self.lib.desmume_memory_write_register(
            c_char_p(strbytes(self.prefix + "r8")), value
        )

    @property
    def r9(self):
        return self.lib.desmume_memory_read_register(
            c_char_p(strbytes(self.prefix + "r9"))
        )

    @r9.setter
    def r9(self, value):
        self.lib.desmume_memory_write_register(
            c_char_p(strbytes(self.prefix + "r9")), value
        )

    @property
    def r10(self):
        return self.lib.desmume_memory_read_register(
            c_char_p(strbytes(self.prefix + "r10"))
        )

    @r10.setter
    def r10(self, value):
        self.lib.desmume_memory_write_register(
            c_char_p(strbytes(self.prefix + "r10")), value
        )

    @property
    def r11(self):
        return self.lib.desmume_memory_read_register(
            c_char_p(strbytes(self.prefix + "r11"))
        )

    @r11.setter
    def r11(self, value):
        self.lib.desmume_memory_write_register(
            c_char_p(strbytes(self.prefix + "r11")), value
        )

    @property
    def r12(self):
        return self.lib.desmume_memory_read_register(
            c_char_p(strbytes(self.prefix + "r12"))
        )

    @r12.setter
    def r12(self, value):
        self.lib.desmume_memory_write_register(
            c_char_p(strbytes(self.prefix + "r12")), value
        )

    @property
    def r13(self):
        return self.lib.desmume_memory_read_register(
            c_char_p(strbytes(self.prefix + "r13"))
        )

    @r13.setter
    def r13(self, value):
        self.lib.desmume_memory_write_register(
            c_char_p(strbytes(self.prefix + "r13")), value
        )

    @property
    def r14(self):
        return self.lib.desmume_memory_read_register(
            c_char_p(strbytes(self.prefix + "r14"))
        )

    @r14.setter
    def r14(self, value):
        self.lib.desmume_memory_write_register(
            c_char_p(strbytes(self.prefix + "r14")), value
        )

    @property
    def r15(self):
        return self.lib.desmume_memory_read_register(
            c_char_p(strbytes(self.prefix + "r15"))
        )

    @r15.setter
    def r15(self, value):
        self.lib.desmume_memory_write_register(
            c_char_p(strbytes(self.prefix + "r15")), value
        )

    @property
    def cpsr(self):
        return self.lib.desmume_memory_read_register(
            c_char_p(strbytes(self.prefix + "cpsr"))
        )

    @cpsr.setter
    def cpsr(self, value):
        self.lib.desmume_memory_write_register(
            c_char_p(strbytes(self.prefix + "cpsr")), value
        )

    @property
    def spsr(self):
        return self.lib.desmume_memory_read_register(
            c_char_p(strbytes(self.prefix + "spsr"))
        )

    @spsr.setter
    def spsr(self, value):
        self.lib.desmume_memory_write_register(
            c_char_p(strbytes(self.prefix + "spsr")), value
        )
...
class DeSmuME_Memory:
    ...
    def read(
        self, start: int, end: int, size: int, signed: bool
    ) -> Union[int, bytes, List[int]]:
        """
...
class DeSmuME:
    ...
    def create_sdl_window(
        self, auto_pause=False, use_opengl_if_possible=True
    ) -> DeSmuME_SDL_Window:
        """
        ...
        if not self._sdl_window:
            self._sdl_window = DeSmuME_SDL_Window(
                self, auto_pause, use_opengl_if_possible
            )
    ...
    def display_buffer_as_rgbx(self, reuse_buffer=True) -> memoryview:
        ...
        if reuse_buffer:
            if not self._raw_buffer_rgbx:
                self._raw_buffer_rgbx = create_string_buffer(
                    SCREEN_WIDTH * SCREEN_HEIGHT_BOTH * 4
                )
    ...
    def screenshot(self) -> Image.Image:
        ...
        return Image.frombuffer(
            "RGB", (SCREEN_WIDTH, SCREEN_HEIGHT_BOTH), buff.raw, "raw", "RGB", 0, 1
        )
